...
class AudioDevice:
    ...
    def get_mixer(self, mixername:str):
    ...
    def get_volume_db(self, mixer:alsaaudio.Mixer):
    ...
    def get_volume_percent(self, mixer:alsaaudio.Mixer):
    ...
    def set_volume_percent(self, mixer:alsaaudio.Mixer, volume:int, channel:int|None):
        if channel is None:
    ...
    def get_range_db(self, mixer:alsaaudio.Mixer):
    ...
    def set_mute(self, mixer:alsaaudio.Mixer):
